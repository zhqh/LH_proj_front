<template>
  ...
  <div class="basic-info">
    ...
    <div class="basic-info"> <nut-divider :style="{ color: 'red', borderColor: '#1989fa', padding: '0 16px' }"
        content-position="left">{{
          $t('create_strategy.long_position') }}</nut-divider></div>
    <div class="stratergy-item grid-head">
      <div class="stratergy-item-left">{{ $t('common.num') }}
      </div>
      <div class="stratergy-item-left">{{ $t('create_strategy.quantity') }}({{
        baseStrategyParam.param.unit }})<span></span>
      </div>
    ...
    <div class="stratergy-item grid-line" v-for="(item, index) in baseStrategyParam.param.customParam.long_grid_lines"
      :key="item.id">
    ...
    <div class="basic-info"> <nut-divider :style="{ color: 'green', borderColor: '#1989fa', padding: '0 16px' }"
        content-position="left">{{
          $t('create_strategy.short_position') }}</nut-divider></div>
    <div class="stratergy-item grid-head">
      <div class="stratergy-item-left">{{ $t('common.num') }}
      </div>
    ...
    <div class="stratergy-item grid-line" v-for="(item, index) in baseStrategyParam.param.customParam.short_grid_lines"
      :key="item.id">
      <div class="stratergy-item-left"><span>{{ index + 1 }}</span>
      </div>
      <div class="stratergy-item-left"><span>{{ item.quantity }}</span>
